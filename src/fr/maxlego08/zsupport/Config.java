...
public class Config implements Saveable {
	...
	static {
		...
		plugins.add(new Plugin("zAuctionHouse", 809473314077802496l, 613374375240138761l, 1, 10));
		...
		plugins.add(new Plugin("zAuctionHouse Redis", 941723116873326623l, 941723181348192277l, 210, 15));
