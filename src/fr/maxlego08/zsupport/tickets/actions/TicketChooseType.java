...
public class TicketChooseType extends TicketAction {
    ...
    public void process(Interaction interaction) {
        ...
        PermissionOverrideAction permissionOverrideAction1 = textChannel.upsertPermissionOverride(this.member);
        permissionOverrideAction1.setAllowed(Permission.VIEW_CHANNEL).queue(e -> {
            ...
            action.queue(e2 -> {
                permissionOverrideAction1.setAllowed(Permission.VIEW_CHANNEL).queue();
            });
