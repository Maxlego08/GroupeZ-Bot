...
public class CommandPurchase extends VCommand {
	...
	protected CommandType perform(ZSupport main) {
		...
		desc += "\n";
		desc += "Après l'achat vous pouvez créer un ticket dans " + channel.getAsMention() +" pour demander l'accès sur spigot.";
		desc += "\n";
		desc += "\n";
		...
		Button buttonUrl = Button.link("https://groupez.dev/resources", "Click to access the marketplace");
